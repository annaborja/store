class MembershipsController < ApplicationController
  ...
  def create
    ...
    return redirect_to(new_membership_path) unless flash[:errors].empty?
    ...
    create_membership(membership_level, num_guests)
  ...
  def new
    ...
    return redirect_to(membership_path) if @membership_levels.empty?
  ...
  def create_membership(membership_level, num_guests)
    ...
    return if current_user.stripe_customer
